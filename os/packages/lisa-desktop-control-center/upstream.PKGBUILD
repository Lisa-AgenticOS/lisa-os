# VENDORED FROM ARCH — do not hand-edit. This is the upstream PKGBUILD our
# fork is derived from, kept beside it so check-fork-derivation.py can prove
# offline that every field we did NOT deliberately change still matches.
#
#   repo:   https://gitlab.archlinux.org/archlinux/packaging/packages/gnome-control-center
#   commit: 093d969dbc37623ff86f939b3f39fedcd953e373  ("50.4-1", 2026-07-31)
#   fetched: 2026-08-06
#
# Refresh with: python3 os/repo-tools/check-fork-derivation.py --refresh
