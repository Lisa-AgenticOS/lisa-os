...
- **Status:** accepted, partially executed — §4's consent surface shipped:
  `shell/consent/lisa-consentd.js` and `dev.lisaos.Consent1` split the
  confirmation UI out of the model host (#135). The rest of the wireframe —
  §2's prompt in the dock above all — is still design.
- Date: 2026-07-27
